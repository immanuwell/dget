...
func printUsageExamples() {
	...
	fmt.Println("  dget example --tld com")
	...
	fmt.Println("  dget --domains-file domains.txt --tld com")
	fmt.Println("  dget --domains-file domains.txt --tld-file tlds.txt")
	fmt.Println()
...
func printHelp() {
	...
	fmt.Println()
	fmt.Println("Options:")
	fmt.Println("  --base <name>         Base domain name (can be comma-separated or used multiple times)")
	fmt.Println("  --tld <tld>           Top-level domain (can be comma-separated or used multiple times)")
	fmt.Println("  --domains-file <file> File containing base domain names (one per line)")
	fmt.Println("  --tld-file <file>     File containing TLDs (one per line)")
